    ...
    <div class="mx-auto max-w-3xl">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 space-y-6 md:space-y-0 md:space-x-2 py-8">
            <div class="flex items-center pl-4 border border-black rounded-xl">
                <input id="bordered-radio-1" type="radio" value="" name="bordered-radio" class="w-4 h-4 text-blue-600 border-gray-300 focus:ring-blue-500 focus:ring-2">
            ...
            <div class="flex items-center pl-4 border border-black rounded-xl">
                <input checked id="bordered-radio-2" type="radio" value="" name="bordered-radio" class="w-4 h-4 text-blue-600 border-gray-300 focus:ring-blue-500 focus:ring-2">
        ...
        <button class="w-full md:w-auto md:rounded-xl bg-black hover:bg-gray-700 text-white py-3 px-6">
            Create Profile
        </button>
    </div>
</div>
